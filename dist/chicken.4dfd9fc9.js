...
apply.onclick = function() {
    if (radio1.checked == false || radio2.checked == false || radio3.checked == false || radio4.checked == false) console.log("click first");
    let divChildren = document.querySelectorAll(".price");
    let stored = [];
    divChildren.forEach((ele)=>{
        stored.push(ele);
    ...
    if (radio2.checked == true) {
        ...
        let stored21 = stored1.sort((a, b)=>{
            return a.getAttribute("dilevery") - b.getAttribute("dilevery");
        });
        let stored31 = "";
        stored21.forEach((ele)=>{
            stored31 += ele.innerHTML;
        });
        dileveryData.innerHTML = stored31;
    }
    if (radio3.checked == true) {
        ...
        let stored22 = stored1.sort((a, b)=>{
            return a.getAttribute("price") - b.getAttribute("price");
        });
        let stored32 = "";
        stored22.forEach((ele)=>{
            stored32 += ele.innerHTML;
        });
        sortedData.innerHTML = stored32;
    }
    if (radio4.checked == true) {
        ...
        let stored23 = stored1.sort((a, b)=>{
            return b.getAttribute("price") - a.getAttribute("price");
        });
        let stored33 = "";
        stored23.forEach((ele)=>{
            stored33 += ele.innerHTML;
        });
        sortedData2.innerHTML = stored33;
    }
};
...
//# sourceMappingURL=chicken.4dfd9fc9.js.map
